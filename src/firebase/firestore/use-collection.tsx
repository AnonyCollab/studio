  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (error: FirestoreError) => {
        ...
        // --- ENHANCED LOGGING ---
        console.error("Firestore Security Rules Error Encountered:", {
          message: "The following request was denied by your security rules.",
          deniedRequest: contextualError.request, // The simulated request object
          rawError: error, // The original error object from Firebase
        });
        // -------------------------
