...
export function ArticleCard({
  ...
  if (featured) {
    return (
      <article onClick={handleCardClick} className={`mb-12 pb-12 ${isDark ? "border-white/5" : "border-gray-100"} border-b cursor-pointer group`}>
  ...
  return (
    <article onClick={handleCardClick} className={`mb-10 pb-10 ${isDark ? "border-white/5" : "border-gray-100"} border-b last:border-b-0 cursor-pointer group`}>
