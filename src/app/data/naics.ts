...
// src/lib/data/appData.ts

// These types were previously in src/types/post.ts
export interface Industry {
  ...
  // This was previously in src/components/layout/MainLayout.tsx
  ...
  // Helper function to find industry details by a specific code
  export const findIndustryByCode = (
