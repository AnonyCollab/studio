...
export function SideTaskPickerModal({ onClose, onSelect, tasks, currentTaskId, isLight }: SideTaskPickerModalProps) {
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-white/5">
            <h3 className={`font-bold ${textMain}`}>Select a Task to View</h3>
