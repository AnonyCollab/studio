        ...
        <div className="flex flex-wrap gap-3">
          <button className={`flex items-center gap-2 px-4 py-2 rounded-lg border transition-all ${
            isDark 
              ...
              : "border-gray-300 text-gray-700 hover:border-cyan-600/50 hover:text-cyan-600"
          }`}>
          ...
          <Input
            ...
            className={`pl-10 ${
              isDark 
                ...
                : "bg-gray-100 border-gray-300 text-gray-900 placeholder:text-gray-400 focus:border-cyan-600/50"
            }`}
          />
        </div>
      </div>
      ...
      <div>
        ...
        <Select>
          ...
          <SelectContent className={isDark ? "bg-[#1a1f2e] border-white/10" : "bg-white border-gray-200"}>
            <SelectItem value="all" className={isDark ? "text-white focus:bg-white/10" : "text-gray-900 focus:bg-gray-100"}>
              All Sectors
            </SelectItem>
            <SelectItem value="arts" className={isDark ? "text-white focus:bg-white/10" : "text-gray-900 focus:bg-gray-100"}>
              Arts, Entertainment, and Recreation
            </SelectItem>
            <SelectItem value="tech" className={isDark ? "text-white focus:bg-white/10" : "text-gray-900 focus:bg-gray-100"}>
              Information Technology
            </SelectItem>
            <SelectItem value="healthcare" className={isDark ? "text-white focus:bg-white/10" : "text-gray-900 focus:bg-gray-100"}>
              Healthcare and Social Assistance
            </SelectItem>
            <SelectItem value="finance" className={isDark ? "text-white focus:bg-white/10" : "text-gray-900 focus:bg-gray-100"}>
